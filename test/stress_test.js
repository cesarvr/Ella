...
*/
jvm.setClassPath('-Djava.class.path=.:/Users/cvaldez/Desktop/NWR/java/lib/itext-5.5.8/itextpdf-5.5.8.jar:/Users/cvaldez/Desktop/NWR/java/lib/itext-5.5.8/xmlworker-5.5.8.jar:/Users/cvaldez/Desktop/NWR/java/PDFHtml/bin/');
...
jvm.start(function(java) {
    ...
    for (var i = 0; i < 10000; i++) {
        console.log('-->', obj.concatHeavy("con", "cat", 2000, function(r) {
            console.log('->', r);
        }));
    }
